...
class ResetPasswordController extends AbstractController
{
    ...
    public function update(Request $request, $token, UserPasswordEncoderInterface $encoder): Response
    {
        ...
        if ($now > $reset_password->getCreatedAt()->modify('+ 3 hour')) {
            $this->addFlash('notice', 'Votre demande de mot e passe a expiré. Merci de la renouveller.');
            return $this->redirectToRoute('app_reset_password');
        }

        // Rendre une vue avec mot de pass et confirmez votre mot de passe.
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            $this->addFlash('notice', 'Votre mot de passe a bie été mis à jour.');
